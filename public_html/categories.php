...
$statement = 'products WHERE products_sub_categories = '.$_GET['id'].' ORDER BY products_id DESC'; 
            ...
            <div class="ps-layout--shop">
                ...
                <div class="ps-layout__right">
                    <div class="ps-shopping ps-tab-root">
                        ...
                        <?php 
                            $all_products = mysqli_query($connect,"SELECT products_id  FROM products WHERE products_sub_categories = '".$_GET['id']."'") or die(db_conn_error);
...
?>
                                ...
                                <?php echo pagination($statement,$per_page,$page,$url=GEN_WEBSITE.'/categories.php?id='.$_GET['id'].'&'); ?>
